...
<html>
 <body>
  ...
  <p>Stops the vehicle from returning to base and resumes flight.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <p>Turns the vehicle's visible or infrared lights on or off.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <p>Requests vehicle to send current mid-level commands to ground station.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <p>Requests storage of mid-level commands.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
