...
<html>
 <body>
  ...
  <h3 id="MAV_CMD_NAV_ALTITUDE_WAIT">MAV_CMD_NAV_ALTITUDE_WAIT (<a href="#MAV_CMD_NAV_ALTITUDE_WAIT">83</a>
   )
  </h3>
  <p>Mission command to wait for an altitude or downwards vertical speed. This is meant for high altitude balloon launches, allowing the aircraft to be idle until either an altitude is reached or a negative vertical speed is reached (indicating early balloon burst). The wiggle time is how often to wiggle the control surfaces to prevent them seizing up.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_POWER_OFF_INITIATED">MAV_CMD_POWER_OFF_INITIATED (<a href="#MAV_CMD_POWER_OFF_INITIATED">42000</a>
   )
  </h3>
  <p>A system wide power-off event has been initiated.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_SOLO_BTN_FLY_CLICK">MAV_CMD_SOLO_BTN_FLY_CLICK (<a href="#MAV_CMD_SOLO_BTN_FLY_CLICK">42001</a>
   )
  </h3>
  <p>FLY button has been clicked.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_SOLO_BTN_FLY_HOLD">MAV_CMD_SOLO_BTN_FLY_HOLD (<a href="#MAV_CMD_SOLO_BTN_FLY_HOLD">42002</a>
   )
  </h3>
  <p>FLY button has been held for 1.5 seconds.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_SOLO_BTN_PAUSE_CLICK">MAV_CMD_SOLO_BTN_PAUSE_CLICK (<a href="#MAV_CMD_SOLO_BTN_PAUSE_CLICK">42003</a>
   )
  </h3>
  <p>PAUSE button has been clicked.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_FIXED_MAG_CAL">MAV_CMD_FIXED_MAG_CAL (<a href="#MAV_CMD_FIXED_MAG_CAL">42004</a>
   )
  </h3>
  <p>Magnetometer calibration based on fixed position
        in earth field given by inclination, declination and intensity.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_FIXED_MAG_CAL_FIELD">MAV_CMD_FIXED_MAG_CAL_FIELD (<a href="#MAV_CMD_FIXED_MAG_CAL_FIELD">42005</a>
   )
  </h3>
  <p>Magnetometer calibration based on fixed expected field values in milliGauss.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_DO_START_MAG_CAL">MAV_CMD_DO_START_MAG_CAL (<a href="#MAV_CMD_DO_START_MAG_CAL">42424</a>
   )
  </h3>
  <p>Initiate a magnetometer calibration.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_DO_ACCEPT_MAG_CAL">MAV_CMD_DO_ACCEPT_MAG_CAL (<a href="#MAV_CMD_DO_ACCEPT_MAG_CAL">42425</a>
   )
  </h3>
  <p>Initiate a magnetometer calibration.</p>
  <table class="sortable">
  ...
  <h3 id="MAV_CMD_DO_CANCEL_MAG_CAL">MAV_CMD_DO_CANCEL_MAG_CAL (<a href="#MAV_CMD_DO_CANCEL_MAG_CAL">42426</a>
   )
  </h3>
  <p>Cancel a running magnetometer calibration.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_ACCELCAL_VEHICLE_POS">MAV_CMD_ACCELCAL_VEHICLE_POS (<a href="#MAV_CMD_ACCELCAL_VEHICLE_POS">42429</a>
   )
  </h3>
  <p>Used when doing accelerometer calibration. When sent to the GCS tells it what position to put the vehicle in. When sent to the vehicle says what position the vehicle is in.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_DO_SEND_BANNER">MAV_CMD_DO_SEND_BANNER (<a href="#MAV_CMD_DO_SEND_BANNER">42428</a>
   )
  </h3>
  <p>Reply with the version banner.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_SET_FACTORY_TEST_MODE">MAV_CMD_SET_FACTORY_TEST_MODE (<a href="#MAV_CMD_SET_FACTORY_TEST_MODE">42427</a>
   )
  </h3>
  <p>Command autopilot to get into factory test/diagnostic mode.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_GIMBAL_RESET">MAV_CMD_GIMBAL_RESET (<a href="#MAV_CMD_GIMBAL_RESET">42501</a>
   )
  </h3>
  <p>Causes the gimbal to reset and boot as if it was just powered on.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_GIMBAL_AXIS_CALIBRATION_STATUS">MAV_CMD_GIMBAL_AXIS_CALIBRATION_STATUS (<a href="#MAV_CMD_GIMBAL_AXIS_CALIBRATION_STATUS">42502</a>
   )
  </h3>
  <p>Reports progress and success or failure of gimbal axis calibration procedure.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_GIMBAL_REQUEST_AXIS_CALIBRATION">MAV_CMD_GIMBAL_REQUEST_AXIS_CALIBRATION (<a href="#MAV_CMD_GIMBAL_REQUEST_AXIS_CALIBRATION">42503</a>
   )
  </h3>
  <p>Starts commutation calibration on the gimbal.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_GIMBAL_FULL_RESET">MAV_CMD_GIMBAL_FULL_RESET (<a href="#MAV_CMD_GIMBAL_FULL_RESET">42505</a>
   )
  </h3>
  <p>Erases gimbal application and parameters.</p>
  <table class="sortable">
   <thead>
    <tr>
     <th>Param</th>
  ...
  <h3 id="MAV_CMD_FLASH_BOOTLOADER">MAV_CMD_FLASH_BOOTLOADER (<a href="#MAV_CMD_FLASH_BOOTLOADER">42650</a>
   )
  </h3>
